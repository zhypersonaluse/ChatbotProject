...
embedding = intial_embedding()
db_C1 = initial_db(docs=split_docs_C1, collection_name="Company-One", embedding=embedding, db_path=C1_DB_PATH)
db_C2 = initial_db(docs=split_docs_C2, collection_name="Company-Two", embedding=embedding, db_path=C2_DB_PATH)
